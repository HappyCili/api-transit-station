...
func (h *OpenAIGatewayHandler) Images(c *gin.Context) {
	...
	routingModel := resolveOpenAIImagesRoutingModel(parsed, channelMapping)
...
func resolveOpenAIImagesRoutingModel(parsed *service.OpenAIImagesRequest, channelMapping service.ChannelMappingResult) string {
