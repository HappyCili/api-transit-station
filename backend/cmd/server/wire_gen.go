...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	imageGenerationService := service.NewImageGenerationService(imageGenerationRepository)
	imageGenerationHandler := handler.NewImageGenerationHandler(imageGenerationService, apiKeyService, configConfig)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, imageGenerationHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
