...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  nowpayments: { notifyUrl: '/api/v1/payment/webhook/nowpayments' },
}
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  nowpayments: [
    { key: 'apiKey', label: 'API Key', sensitive: true, hintKey: 'admin.settings.payment.field_nowpaymentsApiKeyHint' },
    { key: 'ipnSecret', label: 'IPN Secret', sensitive: true, hintKey: 'admin.settings.payment.field_nowpaymentsIpnSecretHint' },
    { key: 'currency', label: '标价币种', sensitive: false, defaultValue: 'USDT', hintKey: 'admin.settings.payment.field_nowpaymentsCurrencyHint' },
    { key: 'payCurrency', label: '收款币种', sensitive: false, defaultValue: 'usdttrc20', hintKey: 'admin.settings.payment.field_nowpaymentsPayCurrencyHint' },
  ],
}
