  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_nowpaymentsApiKeyHint: 'Obtain from NowPayments Dashboard → Settings → API Keys',
        field_nowpaymentsIpnSecretHint: 'IPN callback signature secret. Configure in NowPayments Dashboard → Settings → IPN',
        field_nowpaymentsCurrencyHint: 'Pricing currency. The currency used to price goods/services — can be fiat (e.g. USD) or stablecoin (e.g. USDT). Default: USDT',
        field_nowpaymentsPayCurrencyHint: 'Pay currency. The crypto the user actually pays in, e.g. usdttrc20 (TRC-20 USDT), btc (Bitcoin), eth (Ethereum). Default: usdttrc20',
