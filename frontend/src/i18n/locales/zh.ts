  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        providerNowpayments: 'NowPayments 虚拟币',
        typeDisabled: '类型已禁用',
        ...
        field_nowpaymentsApiKeyHint: '从 NowPayments 后台 Settings → API Keys 获取',
        field_nowpaymentsIpnSecretHint: 'IPN 回调签名密钥，用于验证回调真实性。在 NowPayments 后台 Settings → IPN 中设置',
        field_nowpaymentsCurrencyHint: '标价货币。即商品/服务的定价币种，可以是法币（如 USD）或稳定币（如 USDT）。默认 USDT',
        field_nowpaymentsPayCurrencyHint: '收款币种。用户实际支付的加密货币代码，如 usdttrc20 (TRC-20 USDT)、btc (Bitcoin)、eth (Ethereum)。默认 usdttrc20',
